...
export default function SupervisedTeachingApplication() {
  ...
  return (
    <>
      <HeaderCard title="Supervised Teaching Application">
        ...
        >
          <Box component="form" noValidate onSubmit={handleSubmit}>
            ...
            <Grid container spacing={2}>
              <Grid item xs={12}>
                <Typography>
                  Please list the course(s) for which you are interested in
                  supervised teaching. Ensure that you select the courses with
                  your desired semester and instructor.
                </Typography>
                <br />
              ...
              <Grid item xs={12}>
                <Typography>
                  Please describe your qualifications for supervised teaching,
                  including any teaching, grading, or tutoring experience. If
                  applicable, mention courses and instructors you have worked
                  with.
                </Typography>
                <TextField
                  required
