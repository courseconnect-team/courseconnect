export const testData = [
  {
    ...
    student_level:
      'Freshman, Sophomore, Junior, Senior, 2-3 students per semester',
    prerequisites:
      'Projects can be customized for background and interest of the student, pending lab needs at the time. Helpful skills (encouraged but not required) include: programming fundamentals, experimental design, data analysis, experience working with children, good people skills, attention to detail, organization, time management. High-achieving freshman encouraged to apply! Students considering graduate school strongly encouraged to apply!',
    credit: '0-3 credits via EGN 4912',
    stipend:
      '1st semester, none unless selected for University Scholars; after trial period, $15/hour up to 10 hours per week',
    application_requirements:
      'Resume, UF unofficial transcripts, faculty interview; email all application requirements to Lisa Anthony',
    application_deadline:
      'applications are accepted on a rolling basis, but first come first served (recommend: Mar 15 or July 1 for Fall, Nov 15 for Spring, Mar 15 for Summer)',
  ...
  {
    project_title:
      'dawdawdawdawdaIntelligent Natural Interaction Technology (INIT) Lab',
    department: 'Computer and Information Sciences and Engineering',
    faculty_mentor: 'Lisa Anthony',
    phd_student_mentor: 'TBD based on project and availability',
    terms_available: 'Fall, Spring, Summer',
