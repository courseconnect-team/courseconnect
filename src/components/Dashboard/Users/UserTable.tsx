...
function UserTableHead(props: EnhancedTableProps) {
  const {
    onSelectAllClick,
    order,
    orderBy,
...
function UserTableToolbar(props: EnhancedTableToolbarProps) {
...
export default function UserTable() {
  ...
  const [orderBy, setOrderBy] = React.useState<keyof UserData>('firstname');
