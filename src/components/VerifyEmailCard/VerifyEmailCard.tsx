    ...
    <div className="status-card2">
      <div className="overlap">
        ...
        <div className={`coarse-assistant-wrapper`}>
          <div className="text-wrapper-7">We have sent a verification email to </div>
        </div>
        <div className="overlap-2">
          <div className="div-wrapper">
            <div style={{ color: "#6c6c6c", fontSize: "18px", marginTop: "7px", marginLeft: "-1px" }}>{email}</div>
          </div>
        </div>
        ...
        <div className="overlap-2">
          <div className="div-wrapper">
            <div onClick={e => user.sendEmailVerification().then(function() {
            ...
            } style={{ color: "#6c6c6c", fontSize: "18px", width: "300px", marginTop: "167px", marginLeft: "-1px" }}>Resend Verification Email</div>
          </div>
        </div>
      </div>
